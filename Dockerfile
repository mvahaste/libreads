...
# Copy migration SQL files and scripts
...
COPY --from=builder --chown=node:node /app/prisma/migrate.mjs ./prisma/migrate.mjs
...
# Run migrations, seed database, and start Next.js standalone server
