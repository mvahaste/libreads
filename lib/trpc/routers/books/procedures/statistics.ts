...
async function getTopAuthors(userId: string, limit = 5) {
...
async function getTopGenres(userId: string, limit = 5) {
...
async function getTopSeries(userId: string, limit = 5) {
...
async function getTopPublishers(userId: string, limit = 5) {
...
async function getTopTags(userId: string, limit = 5) {
